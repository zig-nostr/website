...
is coverage: the bundled faces carry Latin, Cyrillic and Greek, so any other script is drawn
as empty boxes until a broader face ships. Windows is not in CI at
